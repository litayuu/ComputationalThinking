                ...
                <div class="overflow-hidden py-5 flex flex-col justify-center items-center rounded-xl bg-orange-FF7F09">
                    ...
                    <div class="md:px-6 px-1 py-2 font-sans text-white md:text-left text-center">
                        <p class="text-lg py-2">
                            Perhatikan baik-baik Soal Tantangan dan jangan terburu-buru dalam mengerjakannya.
                        </p>
                    </div>
                    <a href="{{ url('/siswa/konsep') }}" class="group relative flex w-auto justify-center rounded-lg hover:opacity-70">
                        <img src={{asset('img/tantangan.png')}} alt="logo" class="sm:h-16 h-12 w-auto">
                    </a>
                    <div class="md:px-6 px-1 py-2 font-sans text-white md:text-left text-center">
                        <p class="text-lg py-2">
                            Atau kamu masih belum paham dengan materi yang diberikan?
                        </p>
                    </div>                    
                    <a href="{{ url('/siswa/list_materi') }}" class="group relative flex w-auto justify-center rounded-lg hover:opacity-70">
                        <img src={{asset('img/matri.png')}} alt="logo" class="sm:h-16 h-12 w-auto">
                    </a>
                </div>
            </div>            
        </div>
