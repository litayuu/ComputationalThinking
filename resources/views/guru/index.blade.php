...
<head>
    ...
    <title>Dashboard Guru | Computer Thinking</title>
</head>
    ...
    <section class="flex min-h-full items-center justify-center px-4 py-8 sm:px-6 lg:px-8 overflow-hidden">
        <div class="w-full max-w-md">
            ...
            <div class="pt-10 flex flex-col justify-center items-center space-y-10">
                <a href="{{ url('/guru/materi') }}" class="group relative flex w-auto justify-center rounded-lg hover:opacity-70">
                    <img src={{asset('img/materi.png')}} alt="logo" class="sm:h-16 h-12 w-auto">
                </a>
                <a href="{{ url('/guru/konsep') }}" class="group relative flex w-auto justify-center rounded-lg hover:opacity-70">
