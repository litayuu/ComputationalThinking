            ...
            <div class="w-full py-0 px-5 space-y-10">
                ...
                <div class="w-full overflow-hidden rounded-lg shadow-xs">
                    ...
                    <form class="py-3 font-roboto px-5 space-y-8" method="POST" action="{{ url('/guru/konsep/konsep_add') }}" onsubmit="return confirmSubmit()" enctype="multipart/form-data">
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                            <input type="text" name="a" id="a" class="ckeditor block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 text-white border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:broder-blue-56A5ED peer" value="{{ old('a') }}" required></input>
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                            <input type="text" name="b" id="b" class="ckeditor block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 text-white border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:broder-blue-56A5ED peer" value="{{ old('b') }}" required></input>
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                            <input type="text" name="c" id="c" class="ckeditor block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 text-white border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:broder-blue-56A5ED peer" value="{{ old('c') }}" required></input>
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                            <input type="text" name="d" id="d" class="ckeditor block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 text-white border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:broder-blue-56A5ED peer" value="{{ old('d') }}" required></input>
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                            <input type="text" name="kunci" id="kunci" class="ckeditor block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 text-white border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:broder-blue-56A5ED peer" value="{{ old('kunci') }}" required></input>
