        ...
        <div class="container mx-auto py-0 flex justify-center">
            <div class="w-full py-0 px-5 md:px-10">
                ...
                <div class="w-full overflow-hidden rounded-lg shadow-xs py-5">
                    ...
                    <form class="py-3 font-roboto px-5" method="POST" action="/guru/konsep/konsep_update/{{$edit->id}}" onsubmit="return confirmSubmit()" enctype="multipart/form-data">
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                            <textarea type="text" name="soal" id="soal" class="ckeditor block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 text-white border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:broder-blue-56A5ED peer" >{{ old('materi', $edit->soal) }}</textarea>
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                            <input type="text" name="a" id="a" class="ckeditor block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 text-white border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:broder-blue-56A5ED peer" value="{{ old('materi', $edit->a) }}" ></input>
                            <label for="a" class="-mt-2 peer-focus:font-medium absolute text-sm text-white duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-56A5ED peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">A</label>
                        </div>
                        <div class="relative z-0 w-full mb-6 group">
                            <input type="text" name="b" id="b" class="ckeditor block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 text-white border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:broder-blue-56A5ED peer" value="{{ old('materi', $edit->b) }}" ></input>
                            <label for="b" class="-mt-2 peer-focus:font-medium absolute text-sm text-white duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-56A5ED peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">B</label>
                        </div>
                        <div class="relative z-0 w-full mb-6 group">
                            <input type="text" name="c" id="c" class="ckeditor block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 text-white border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:broder-blue-56A5ED peer" value="{{ old('materi', $edit->c) }}" ></input>
                            <label for="c" class="-mt-2 peer-focus:font-medium absolute text-sm text-white duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-56A5ED peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">C</label>
                        </div>
                        <div class="relative z-0 w-full mb-6 group">
                            <input type="text" name="d" id="d" class="ckeditor block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 text-white border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:broder-blue-56A5ED peer" value="{{ old('materi', $edit->d) }}" ></input>
                            <label for="d" class="-mt-2 peer-focus:font-medium absolute text-sm text-white duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-56A5ED peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">D</label>
                        </div>
                        <div class="relative z-0 w-full mb-6 group">
                            <input type="text" name="kunci" id="kunci" class="ckeditor block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 text-white border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:broder-blue-56A5ED peer" value="{{ old('materi', $edit->kunci) }}" ></input>
                            <label for="kunci" class="-mt-2 peer-focus:font-medium absolute text-sm text-white duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-56A5ED peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Kunci Jawaban</label>
                        </div>
                        <div class="relative z-0 w-full mb-6 group">
