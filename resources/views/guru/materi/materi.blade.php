                        ...
                        <table class="w-full whitespace-no-wrap">
                            ...
                            <tbody class="bg-white-fafafa divide-y">
                                ...
                                <tr class="text-white">
                                    ...
                                    <td class="px-4 py-3 text-sm">
                                        <div class="flex justify-between items-center">
                                            <a href="{{ url ('guru/materi/materi_post', $row->id) }}" type="button" class="group relative flex w-auto justify-center rounded-md bg-orange-FF7F09 px-3 py-2 text-xl font-semibold text-white hover:bg-white hover:text-orange-FF7F09 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-600 shadow shadow-orange-600 hover:shadow-white">
                                                {{ $row->materi }}
                                            </a>
                                        </div>  
                                    </td> 
                                    ...
                                    <td class="px-4 py-3 text-sm">
                                        <a href="/guru/materi/materi_edit/{{$row->id}}" class="bg-red-200 px-2 py-2 rounded-lg hover:opacity-70" onclick="return confirm('Apakah anda yakin ingin mengubah data ?');">
                                            <i class="fi fi-rr-file-edit"></i>
                                        </a>
                                        <a href="/guru/materi/materi_delete/{{$row->id}}" class="bg-red-200 px-2 py-2 rounded-lg hover:opacity-70" onclick="return confirm('Apakah Anda Yakin Menghapus Data?');">
